...
// gesture race to an inner scroll view's pan, making pull-to-dismiss unreliable on
// horizontally-scrollable content. A .sheet's native dismiss (via
// UISheetPresentationController) coordinates with the scroll view, keeping
// pull-to-dismiss sensitive and reliable.
